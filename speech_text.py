...
Label(background="gray", width=100, height=1000).place(x=0,y=0)
Button(text="Record", command =write_text).place(x=10,y=180)
Button(text="Speak", width=5, command=speak).place(x=10,y=220)
Button(text="Save", width=5, command=save).place(x=140,y=180)
sh = Label(text="Say something!",font=("Arial",25) ,background="green")
